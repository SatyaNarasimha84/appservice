...
public class SwaggerConfig {     
	...
	private static final String BEARER_AUTH = "Bearer";
		@Bean
		public Docket api() {
			return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.jayam.appservice.web")).paths(PathSelectors.any()).build().apiInfo(apiInfo())
